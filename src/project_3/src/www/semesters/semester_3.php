<?php
  ...
  $jsFiles = array("https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js", "../../js/comments.js", "../../js/semester_3.js");
  $head      = $pageGenerator->generateHead("Piotr Kawa - Semestr III", $cssStyles, $jsFiles);
