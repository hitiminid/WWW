<?php
  ...
  $jsFiles = array("https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js", "../../js/comments.js", "../../js/semester_6.js");
  $head      = $pageGenerator->generateHead("Piotr Kawa - Semestr VI", $cssStyles, $jsFiles);
